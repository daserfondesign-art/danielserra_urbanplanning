...
const PROJECTS = [
  ...
  },
  {
    ...
    part_es: ['Elaboración de informes de sostenibilidad ambiental', 'Tramitación ante la organismo autonómico competente'],
  ...
  },
  {
    ...
    part_es: ['Tramitación ante la organismo autonómico competente de la GVA', 'Coordinación con el equipo de análisis ambiental'],
    part_en: ['Processing before the organismo autonómico competente', 'Coordination with the environmental analysis team'],
    press: [], link: null,
  },
  {
  ...
  },
  {
    ...
    desc_es: 'Plan General Estructural aprobado definitivamente por la comunidad autónoma para el municipio rural de Llocnou de Sant Jeroni, en la comarca de la Safor. Municipio de carácter eminentemente agrícola, con especial valor paisajístico ligado al cultivo de cítricos y al entorno del río Serpis.\n\nEl trabajo incluyó también la redacción íntegra del Catálogo de Protecciones del municipio, aprobado simultáneamente con el PGE, con fichas individualizadas para cada elemento del patrimonio arquitectónico, etnológico y paisajístico catalogado.',
    ...
    led_es: ['Redacción íntegra del Plan General Estructural adaptado a la LOTUP', 'Catálogo de Protecciones completo con fichas individualizadas — aprobado por la GVA', 'Análisis del paisaje agrícola, natural y patrimonial del municipio', 'Tramitación completa ante la organismo autonómico competente'],
    led_en: ['Complete drafting of the Structural General Plan adapted to the LOTUP', 'Complete Protection Catalogue with individual sheets — approved by GVA', 'Analysis of the agricultural, natural and heritage landscape', 'Full processing before the organismo autonómico competente'],
