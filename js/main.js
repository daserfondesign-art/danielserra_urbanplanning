...
function renderNav(activePage) {
  ...
  <div class="mobile-menu" id="mobile-menu">
    ...
    <div class="mobile-menu-footer">
      <a href="https://www.linkedin.com/in/daniel-serra-font-bb288814b/" target="_blank" rel="noopener" class="mobile-linkedin">
...
function renderFooter() {
  ...
  <footer class="privacy-bar-foot">
    ...
    <a href="https://www.linkedin.com/in/daniel-serra-font-bb288814b/" target="_blank" rel="noopener" class="foot-linkedin">
...
const i18n = {
  es: {
    ...
    ow1_tag: 'Mención Especial', 
    ow1_link: 'Ver en RiuNet UPV',
    ow_various: 'Various', 
    ow2_title: 'Diseño Gráfico y Desarrollo Web',
    ow2_desc: 'Diseño conceptual, UI/UX y programación de ecosistemas digitales, incluyendo este portfolio profesional y la web corporativa de Velat Studio, optimizando la narrativa visual y la experiencia de usuario.',
    ow2_tag: 'Digital',  
    ow3_title: 'Vídeo · Fondos Next Generation EU — Universidad de Murcia',
    ow3_desc: 'Producción y edición del vídeo para fondos Next Generation sobre la renovación de la antigua universidad. Combinó visualización 3D, motion graphics y edición de vídeo.',
    ow3_tag: 'Audiovisual', 
    ow4_title: 'Estudios de Paisaje con simulaciones visuales',
    ...
    sb_btn: 'Contactar', sb_btn_contact: 'Contactar', sb_btn_consult: 'Solicitar consulta', pg_num_blog: '06 — Blog', 
    ...
    /* ── Blog Articles (page content) ── */
    btn_back_blog: 'Volver al Blog', art_lbl_date: 'Fecha', art_lbl_topic: 'Temática', art_lbl_case: 'Caso de Estudio', art_lbl_scope: 'Ámbito',

    art1_tag: 'Estrategia Urbana · Infraestructura Verde',
    art1_title_full: 'De la restricción a la oportunidad: <br><em>los parques inundables como infraestructura verde en suelo productivo</em>',
    art1_bc: 'Parques inundables e Infraestructura Verde',
    art1_val_date: 'Enero 2026', art1_val_topic: 'PATRICOVA / Infraestructura Verde', art1_val_case: 'Sector E-49 (Elche)',
    art1_body: '<p>En el planeamiento urbanístico de la Comunitat Valenciana, la mención al PATRICOVA (Plan de Acción Territorial sobre Prevención del Riesgo de Inundación) suele generar inquietud. Históricamente, las afecciones por riesgo de inundación se han percibido como un muro infranqueable, un factor bloqueante que paraliza desarrollos residenciales e industriales, o que exige infraestructuras de canalización dura con costes económicos inasumibles.</p><p>Sin embargo, el urbanismo contemporáneo exige un cambio de paradigma: <strong>no podemos seguir luchando contra el agua; debemos darle espacio.</strong></p><p>La transición desde el urbanismo expansivo de los años 90 hacia el actual modelo de contención y resiliencia climática nos obliga a repensar cómo gestionamos las escorrentías. Es aquí donde los parques inundables (integrados dentro de los Sistemas Urbanos de Drenaje Sostenible o SUDS) dejan de ser una penalización técnica para convertirse en una oportunidad de diseño excepcional.</p><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">Referentes en la gestión resiliente del agua</h3><p>La integración de áreas de laminación en el paisaje urbano no es una utopía teórica. Existen ejemplos construidos que demuestran una eficacia rotunda:</p><ul style="margin-bottom:2rem;padding-left:1.5rem;color:var(--text-2);font-size:0.96rem;line-height:1.82"><li style="margin-bottom:0.8rem"><strong>Parque La Marjal (Alicante):</strong> Parque capaz de retener 45.000 m³ de agua. Durante el 95% del año funciona como parque público. En lluvias extremas, actúa como vaso de retención.</li><li style="margin-bottom:0.8rem"><strong>Waterplein Benthemplein (Róterdam):</strong> Una «plaza de agua» con tres cuencas que funciona como anfiteatro en seco y alivia el drenaje cuando llueve.</li><li><strong>Parque de Aranzadi (Pamplona):</strong> Diseñado con microrrelieves y bosque de ribera que absorbe las crecidas del río Arga sin alterar la dinámica fluvial.</li></ul><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">El caso práctico: Elche Parque Empresarial (Sector E-49)</h3><p>La <strong>Ampliación del Parque Empresarial de Elche (Sector E-49)</strong> habilitó cerca de 600.000 m² de suelo industrial. Se diseñaron <strong>dos grandes áreas de laminación integradas en las zonas verdes (5,2 hectáreas)</strong> que cumplen una doble función:</p><ol style="margin-bottom:2rem;padding-left:1.5rem;color:var(--text-2);font-size:0.96rem;line-height:1.82"><li style="margin-bottom:0.8rem"><strong>Integración Paisajística:</strong> Zonas colchón frente a las infraestructuras viarias, consolidando la Infraestructura Verde exigida por la LOTUP.</li><li><strong>Mitigación del Riesgo:</strong> Balsas naturalizadas que reducen el pico de avenida y garantizan la seguridad del sector.</li></ol><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">Conclusión: la ingeniería del paisaje como salvoconducto</h3><p>El éxito del Sector E-49 de Elche demuestra que la rigidez normativa puede superarse asumiendo la inundabilidad como un vector de diseño. Cuando los parques inundables se dibujan desde la génesis del Plan General, se dota al documento de una solidez jurídica inexpugnable.</p>',

    art2_tag: 'Planeamiento · Resiliencia Territorial',
    art2_title_full: 'De la burbuja a la razón: <br><em>la desclasificación de suelo</em>',
    art2_bc: 'Desclasificación masiva de suelo',
    art2_val_date: 'Noviembre 2024', art2_val_topic: 'IMOS / Desclasificación / LOTUP', art2_val_case: 'PGE Jávea y Camp del Túria',
    art2_body: '<p>La etapa de la burbuja inmobiliaria dejó en la Comunitat Valenciana una herencia territorial compleja: planeamientos sobredimensionados que dibujaron inmensas manchas de «suelo urbanizable» desconectadas de la realidad demográfica y ambiental.</p><p>Hoy, la <strong>ETCV</strong> y la <strong>LOTUP</strong> imponen un paradigma de contención, obligando a los municipios a purgar ese exceso de suelo. Pero, ¿cómo se ejecuta operativamente una desclasificación masiva sin que el Plan General naufrague en los tribunales?</p><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">La cirugía territorial: metodología para el recorte de suelo</h3><p>Eliminar suelo urbanizable exige una justificación matemática inexpugnable. La superposición de SIG permite racionalizar territorios aplicando filtros restrictivos:</p><ul style="margin-bottom:2rem;padding-left:1.5rem;color:var(--text-2);font-size:0.96rem;line-height:1.82"><li style="margin-bottom:0.8rem"><strong>Filtro 1: Riesgos naturales.</strong> Exclusión de sectores con vulnerabilidad de acuíferos, erosión o inundación (PATRICOVA).</li><li style="margin-bottom:0.8rem"><strong>Filtro 2: Infraestructura Verde.</strong> Preservación de corredores ecológicos, vías pecuarias y normativas supramunicipales.</li><li><strong>Filtro 3: Límite IMOS.</strong> Techo de crecimiento calculado en base a la tasa demográfica real.</li></ul><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">El hito de Jávea</h3><p>El <strong>PGE de Jávea / Xàbia</strong> desclasificó <strong>10 millones de m²</strong> de suelo urbanizable. El verdadero éxito fue blindarlo jurídicamente con <strong>144 informes sectoriales favorables</strong>, cerrando cualquier fisura legal.</p><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">Conclusión</h3><p>Desclasificar para proteger es hoy la única vía para dotar de seguridad jurídica a los Ayuntamientos y garantizar que el crecimiento futuro se concentre donde el territorio lo soporta.</p>',

    art3_tag: 'Análisis Territorial',
    art3_title_full: 'La amenaza de la conurbación: <br><em>por qué necesitamos pasillos verdes</em>',
    art3_bc: 'La amenaza de la conurbación',
    art3_val_date: 'Junio 2025', art3_val_topic: 'Infraestructura Verde / Paisaje', art3_val_scope: 'Camp del Túria / Área Metropolitana',
    art3_body: '<p>Uno de los fenómenos más críticos en las áreas metropolitanas es la conurbación: la unión física de núcleos urbanos antes independientes. Las fronteras municipales se desdibujan, las identidades locales se pierden y la resiliencia del territorio se desploma.</p><p>En el <strong>Camp del Túria</strong>, este riesgo es tangible. La presión por rellenar los huecos entre poblaciones es un problema de sostenibilidad estructural.</p><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">La Infraestructura Verde como límite físico</h3><p>La ETCV propone la <strong>Infraestructura Verde</strong> como elemento de contención. Los pasillos verdes cumplen funciones vitales:</p><ul style="margin-bottom:2rem;padding-left:1.5rem;color:var(--text-2);font-size:0.96rem;line-height:1.82"><li style="margin-bottom:0.8rem"><strong>Identidad Territorial:</strong> Cada núcleo conserva su legibilidad urbana y patrimonio paisajístico.</li><li style="margin-bottom:0.8rem"><strong>Regulación Climática:</strong> Los pasillos verdes actúan como sumideros de CO2 y permiten la circulación de brisas.</li><li><strong>Continuidad Ecológica:</strong> Evitan el «efecto isla» y permiten el flujo de biodiversidad.</li></ul><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">Del análisis a la propuesta</h3><p>El futuro del urbanismo no pasa por decidir cuánto más crecer, sino por definir con precisión <strong>dónde debemos dejar de hacerlo</strong>.</p>',
  ...
  en: {
    ...
    ow1_tag: 'Special Mention', 
    ow1_link: 'View on RiuNet UPV',
    ow_various: 'Various', 
    ow2_title: 'Graphic Design and Web Development',
    ow2_desc: 'Conceptual design, UI/UX, and programming of digital ecosystems, including this professional portfolio and the Velat Studio corporate website, optimizing visual narrative and user experience.',
    ow2_tag: 'Digital',  
    ow3_title: 'Video · Next Generation EU Funds — University of Murcia',
    ow3_desc: 'Production and editing of the video for Next Generation funds on university building renewal. Combined 3D visualisation, motion graphics and video editing.',
    ow3_tag: 'Audiovisual', 
    ow4_title: 'Landscape Studies with visual simulations',
    ...
    sb_btn: 'Contact', sb_btn_contact: 'Get in touch', sb_btn_consult: 'Request consultation', pg_num_blog: '06 — Blog', 
    ...
    /* ── Blog Articles (page content) ── */
    btn_back_blog: 'Back to Blog', art_lbl_date: 'Date', art_lbl_topic: 'Topic', art_lbl_case: 'Case Study', art_lbl_scope: 'Scope',

    art1_tag: 'Urban Strategy · Green Infrastructure',
    art1_title_full: 'From restriction to opportunity: <br><em>floodable parks as green infrastructure in productive land</em>',
    art1_bc: 'Floodable parks & Green Infrastructure',
    art1_val_date: 'January 2026', art1_val_topic: 'PATRICOVA / Green Infrastructure', art1_val_case: 'Sector E-49 (Elche)',
    art1_body: '<p>In the urban planning of the Valencian Community, any mention of PATRICOVA (the Territorial Action Plan for Flood Risk Prevention) tends to cause unease. Historically, flood risk restrictions have been perceived as an insurmountable wall that paralyses residential and industrial developments or demands costly hard drainage infrastructure.</p><p>However, contemporary urbanism demands a paradigm shift: <strong>we can no longer fight against water; we must give it space.</strong></p><p>The transition from the expansive urbanism of the 1990s towards a model of containment and climate resilience compels us to rethink how we manage runoff. This is where floodable parks (integrated within Sustainable Urban Drainage Systems or SUDS) cease to be a technical penalty and become an exceptional design opportunity.</p><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">References in resilient water management</h3><p>Integrating lamination areas into the urban landscape is no theoretical utopia. There are built examples that have proven highly effective:</p><ul style="margin-bottom:2rem;padding-left:1.5rem;color:var(--text-2);font-size:0.96rem;line-height:1.82"><li style="margin-bottom:0.8rem"><strong>La Marjal Park (Alicante):</strong> A park capable of retaining 45,000 m³ of water. For 95% of the year it functions as a public park. During extreme rainfall, it acts as a retention basin.</li><li style="margin-bottom:0.8rem"><strong>Waterplein Benthemplein (Rotterdam):</strong> A "water square" with three basins that works as an amphitheatre when dry and relieves drainage when it rains.</li><li><strong>Aranzadi Park (Pamplona):</strong> Designed with micro-reliefs and riparian forest that absorbs the regular floods of the River Arga without altering natural fluvial dynamics.</li></ul><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">The practical case: Elche Business Park (Sector E-49)</h3><p>The <strong>Elche Business Park Expansion (Sector E-49)</strong> enabled nearly 600,000 m² of industrial land. <strong>Two large lamination areas integrated into the green spaces (5.2 hectares total)</strong> were designed to serve a dual purpose:</p><ol style="margin-bottom:2rem;padding-left:1.5rem;color:var(--text-2);font-size:0.96rem;line-height:1.82"><li style="margin-bottom:0.8rem"><strong>Landscape Integration:</strong> Buffer zones against road infrastructure, consolidating the Green Infrastructure required by LOTUP.</li><li><strong>Risk Mitigation:</strong> Naturalised basins that reduce peak flooding and ensure sector safety.</li></ol><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">Conclusion: landscape engineering as a safe-conduct</h3><p>The success of Elche\'s Sector E-49 demonstrates that regulatory rigidity can be overcome by embracing flood risk as a design driver. When floodable parks are drawn from the very genesis of the General Plan, the document gains unassailable legal robustness.</p>',

    art2_tag: 'Planning · Territorial Resilience',
    art2_title_full: 'From the bubble to reason: <br><em>massive land declassification</em>',
    art2_bc: 'Massive land declassification',
    art2_val_date: 'November 2024', art2_val_topic: 'IMOS / Declassification / LOTUP', art2_val_case: 'SGP Jávea and Camp del Túria',
    art2_body: '<p>The housing bubble left the Valencian Community with a complex territorial legacy: oversized municipal plans that drew vast swathes of "developable land" disconnected from demographic and environmental reality.</p><p>Today, the <strong>ETCV</strong> and <strong>LOTUP</strong> impose a containment paradigm, forcing municipalities to purge that excess land. But how can a massive declassification be executed without the General Plan sinking in the courts?</p><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">Territorial surgery: methodology for land reduction</h3><p>Eliminating developable land requires an unassailable mathematical justification. GIS overlay analysis allows entire territories to be rationalised through restrictive filters:</p><ul style="margin-bottom:2rem;padding-left:1.5rem;color:var(--text-2);font-size:0.96rem;line-height:1.82"><li style="margin-bottom:0.8rem"><strong>Filter 1: Natural hazards.</strong> Exclusion of sectors with aquifer vulnerability, erosion risk, or flood hazards (PATRICOVA).</li><li style="margin-bottom:0.8rem"><strong>Filter 2: Green Infrastructure.</strong> Preservation of ecological corridors, livestock trails, and supra-municipal regulations.</li><li><strong>Filter 3: IMOS threshold.</strong> A growth ceiling calculated from actual demographic rates.</li></ul><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">The Jávea milestone</h3><p>The <strong>SGP of Jávea / Xàbia</strong> declassified <strong>10 million m²</strong> of previously developable land. The real achievement was shielding it legally with <strong>144 favourable sectoral reports</strong>, closing every possible legal loophole.</p><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">Conclusion</h3><p>Declassifying to protect is today the only path to provide legal certainty to municipalities and ensure future growth is concentrated exclusively where the territory can truly sustain it.</p>',

    art3_tag: 'Territorial Analysis',
    art3_title_full: 'The threat of conurbation: <br><em>why we need green corridors</em>',
    art3_bc: 'The threat of conurbation',
    art3_val_date: 'June 2025', art3_val_topic: 'Green Infrastructure / Landscape', art3_val_scope: 'Camp del Túria / Metropolitan Area',
    art3_body: '<p>One of the most critical phenomena in metropolitan areas is conurbation: the physical merging of previously independent urban centres. Municipal boundaries blur, local identities are lost, and territorial resilience collapses.</p><p>In the <strong>Camp del Túria</strong> region, this risk is tangible. The pressure to fill gaps between towns is a structural sustainability problem.</p><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">Green Infrastructure as a physical boundary</h3><p>The ETCV proposes <strong>Green Infrastructure</strong> as a containment tool. Green corridors fulfil vital functions:</p><ul style="margin-bottom:2rem;padding-left:1.5rem;color:var(--text-2);font-size:0.96rem;line-height:1.82"><li style="margin-bottom:0.8rem"><strong>Territorial Identity:</strong> Each settlement retains its urban legibility and landscape heritage.</li><li style="margin-bottom:0.8rem"><strong>Climate Regulation:</strong> Green corridors act as CO2 sinks and allow breeze circulation.</li><li><strong>Ecological Continuity:</strong> They prevent the "island effect" and enable biodiversity flows.</li></ul><h3 style="font-family:var(--serif);font-size:1.4rem;margin:2rem 0 1rem">From analysis to proposal</h3><p>The future of urbanism is not about deciding how much more we can grow, but about defining precisely <strong>where we must stop</strong>.</p>',
